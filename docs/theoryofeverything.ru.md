...
Последняя Pdf версия теории всего: [Теория всего.ru(2023.01.15).pdf](Files/Теория_всего.ru(2023.01.15).pdf)
...
Вы думете, что в эксперименте №3 оба близнеца будут иметь одинаковый возраст?
Только в одном случае из всех. Когда начальная скорость ракет отностиельно вакуума или относительно реликтового излучения была равна нулю. Для всех остальных случаев (была начальная скорость отностиельно вакуума или относительно реликтового излучения) близнецы будут иметь разный возраст (пройдет разное количество периодов всех процессов в их телах).

Моложе будет тот близнец, скорость которого ближе к скорости света относительно вакуума или относительно реликтового излучения.

Эксперимент №3 с конкретным вариантом значений скоростей. 
Два близнеца летят в пристыкованных друг другу ракетах (0.2c относительно вакуума/реликтового излучения/**с погрешностью** относительно Земли). Первый и второй садится в свои ракеты, ускоряются с одинаковым ускорением в разные стороны , летят длительное время (~ c, ~ -0.6c), тормозят с одинаковым ускорением (0.2c), ускоряются в обратном направлении с одинаковым ускорением, летят длительное время (0.19c, 0.21c), тормозят с одинаковым ускорением (0.2c), стыкуются и встречяются в ракете. 
В итоге для данного конкретного случая первый близнец будет моложе второго. Однако для других слуаев будут другие варианты соотношений возрастов. 

-------------
Проведем один из наиболее показательных мысленных экспериментов №4.
Два близнеца летят в пристыкованных друг другу ракетах. Первый и второй садится в свои ракеты, ускоряются с одинаковым ускорением в разные стороны, летят длительное время $t$, ускоряются с одинаковым ускорением в обратном направлении (навстречу друг другу), ускоряются с одинаковым ускорением в одну сторону, ускоряются с одинаковым ускорением в разные стороны, летят длительное время $t$, ускоряются с одинаковым ускорением в обратном направлении (навстречу друг другу), стыкуются и встречяются в ракете. 

Для кого пройдет сколько времени? Специальная теория относительности не даст вам ответа.
Что наблюдается исходя из специальной теории относительности:

--------------

Такого рода эксперименты не сложно провести. Один из простейших вариантов - использовать коротко живущие частицы, которые быстро распадаются при скоростях значительно меньших, чем скорость света. Другой гораздо более сложный, но наглядный вариант это все же использовать ракеты с атомными часами. 

Самый простой способ проверки взять две коротко живущие частицы полученные в одно и тоже время и провести два варианта экспериментов.

Классичексий Парадокс близнецов будет быглядеть так. 

Вариант №1 - разогнанные до одинаковой скорости близкой к нулю относительно вакуума/реликтового излучения/Земли. С точки зрения каждой из них они покоятся. 
Отметим этот момент как начало эксперимента. Ускорим первую частицу таким образом чтобы она двигалась быстрее относительно вакуума/реликтового излучения/Земли (желательно почти до скорости света), подождем значительное время $t$, а затем ускорим в обратном направлении до изначальной скорости (около 0). В результате вторая(покоящаяся/двигающаяся без ускорений) частица распадется быстрее первой.

Обратный вариант Парадокса близнецов будет быглядеть так.

Вариант №2 - разогнанные до одинаковой скорости близкой к скорости света относительно вакуума/реликтового излучения/Земли. С точки зрения каждой из них они покоятся. 
Отметим этот момент как начало эксперимента. Ускорим первую частицу таким образом чтобы она двигалась медленне относительно вакуума/реликтового излучения/Земли (желательно почти до нулевой скорости), подождем значительное время $t$, а затем ускорим в обратном направлении до изначальной скорости (близкой к скорости света. Такой же как и у второй частицы). В результате первая частица распадется быстрее второй. Хотя с точки зрения специальной теории относительности (дополненной пониманием кто ускорялся, а кто нет) должна распасться сначала вторая(покоящаяся/двигающаяся без ускорений), а затем первая. 

Можно проводить этот эксперимент с ракетами, но это будет сложнее реализовать.

Фактически вариант №2 это тот же самый эксперимент из Парадокса близнецов. Но если там начальная скорость относительно вакуума/реликтового излучения/Земли была близкой к нулю, то тут она будет близкой к скорости света. С точки зрения теории относительности это ничего не меняет, так как нам важна именно их скорость относительно друг друга и понимание кто из них ускорялся, а кто нет.

Можно придумать ещё множество вариантов для проверки. Например, возьмем две коротко живущие частицы полученные в одно и тоже время, пусть их начальная скорость 0 относительно вакуума/реликтового излучения/Земли и отметим начало эксперимента. Разгоним их до $0.5c$. Одну ускорим до скорости близкой к скорости света, а другую до 0. Подождем значительное время $t$. Ускорим обе обратно до $0.5c$. Ускорим их обе до 0. С точки зрения каждой из частиц(можно и с кораблями проверять) они двигались и ускорялись одинаково относительно друг друга и в этом то и заключается истиный вариант Парадокса близнецов. И точки зрения каждой из частиц другая двигалась быстрее, а ускорения были одинаковы. И тут уже специальная теория относительности бессильна без введения сторонних наблюдателей даже с учетом ускорений. Более того если сторонний наблюдатель будет двигаться со скоростью близкой к скорости света относительно вакуума/реликтового излучения/Земли, то он сделает ошибочное предположение о том какая частица распадется первой.  
...
В итоге мы снова можем видеть и проверить экспериментально несоответствие специальной теории отностительности Эйнштейна реальности. Опять же повторюсь, что вся проблема в термине секунда, который зависит от скорости движения относительно вакуума/реликтового излучения/Земли. Детали были приведены в разделе "Как дать определение термину «Время», чтобы создать теорию относительности".
