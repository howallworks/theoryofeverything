...
[[Photon.ru|Фотон]] вообще состоит исключительно из группы $к.ф.^+$, либо исключительно из группы $к.ф.^-$. Прохождение поляризатора это тоже воздействие на фотон (группу квант фотонов) и преизлучение, что по сути имеет место для всего безвакуумного пространства.
