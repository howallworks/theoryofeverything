...
### Парадокс близнецов. Эксперимент по проверке специальной теории относительности Эйнштейна
...
Кратко опишем эксперимент №1. Два близнеца находятся на Земле (точка отсчета). 

Первый садится в ракету и улетает, а второй остается ждать его возвращения. Первый ускоряется до скорости близкой к скорости света (относительно точки отсчета), летит продолжительное время, затем тормозит, ускоряется в обратном направлении, летит продолжительное время, тормозит и встречается в точке отчета (на Земле) со своим близнецом. Отмечается что так как первый ускорялся, то он и испытывал "замедление времени" и будет моложе. 

Теперь опишем другой, но очень похожий эксперимент №2. Два близнеца летят на пристыкованных ракетах со скоростью близкой к скорости света (точка отсчета). Уже догадыветесь, что будет дельше? Поехали. 

Первый садится в ракету и улетает, а второй остается ждать его возвращения. Первый ускоряется до скорости близкой к скорости света (относительно точки отсчета), летит продолжительное время, затем тормозит, ускоряется в обратном направлении, летит продолжительное время, тормозит и встречается в точке отчета (на корабле) со своим близнецом. Отмечается что так как первый ускорялся, то он и испытывал "замедление времени" и будет моложе.

Сравним эксперимент №1 и эксперимент №2. Снова получаем Парадокс близнецов. На самом деле для эксперимента №2 не понятно кто будет моложе, так как возможны различные направления ускорения ракеты и соответственно разные скорости относительно вакуума/реликтового излучения, от чего и зависит период процессов в объекте.

Приведем ещё один эксперимент №3.
...
В итоге мы можем провести эксперименты, которые могут подтвердить несоответствие специальной теории отностительности Эйнштейна реальности.
