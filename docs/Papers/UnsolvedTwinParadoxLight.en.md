...
##### Experimental consequences of the inequality of inertial reference frames

Due to the presence of an absolute reference frame, the dynamics of the universe in different inertial reference frames will look different. In an IFR moving at a relativistic velocity relative to an absolute reference frame, the ultrafast dynamics of the universe will be observed. In fact, the processes in it will be greatly slowed down, and the dynamics of the universe will remain unchanged. This will lead to the fact that the observer in this IFR will see all the processes of the universe accelerated by a factor of gamma. That is, the age of the universe will increase gamma times faster than his own. It should be especially noted that this does not take into account the direction of the relativistic motion of the IFR relative to the absolute reference frame. If this is not ignored, then it is necessary to take into account the travel time of photons to the relativistic IFR. We get that in the direction of motion of the relativistic IFR we will bump into the surrounding photons, and in the opposite direction we will run away from the photons, which will very slowly catch up with us.

Due to the IFRs inequality, we cannot even guarantee that the human body will function correctly at relativistic speeds relative to the absolute frame of reference. This generally raises the big question of traveling even across our galaxy. Of course, it will be possible to create a system that will save data about us on a relativistic journey through the galaxy, and then, after decelerating to the absolute frame of reference (ImFR), recreate us. However, this greatly complicates the process and the necessary technologies.
...
To do this, it is necessary to understand the principle of operation of a [[TheReasonForTheMisunderstandingOfTheViolationOfBellsInequality.en|polarizer and the features of its interaction with photons, as well as the reason for the misunderstanding of the violation of the Bell inequality]]. This explains all the observed experimental data and effects without violating locality and realism.
