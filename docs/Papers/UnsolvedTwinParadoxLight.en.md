...
Let's figure out what exactly happens with diffraction and interference. Are there scientifically proven experimental facts that the direction of photons changes in a vacuum without external influences? No. All photons or any other particles that are not affected by anything move uniformly and in a straight line. When does the interference or diffraction pattern occur? Only after interacting with the atoms of the obstacles. That is, it is the atoms of the obstacles that are responsible for the deviation of the trajectories of the particles (re-emission) with a specific vector distribution. Let's look at what exactly happens using the example of a photon. It is well known that the energy and, consequently, the frequency of a photon is quantized. Why? Since a photon is a group of quantum photons and their number determines the energy and frequency of the resulting photon. What happens when a photon interacts with the atoms of an obstacle? Apparently, the electrons of the obstacle interact with the photon and re-emit it with an appropriate vector distribution. Moreover, the higher the energy and frequency, that is, the number of quantum photons in a photon, the more difficult it is for an electron to deflect a photon and the smaller the angles of re-emission. The same thing happens in the case of interference or diffraction with other particles. And again, no magic. Everything is simple and clear.
