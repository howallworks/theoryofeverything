...
The description of the thought experiment is presented in which objects move at a speed tending to infinity, which contradicts the limiting speed of light according to the theory of relativity.
...
To improve the quality of understanding of what is happening, let's assume that the entire space is filled with fine dust motionless in $IFR_{o3}$. Then it becomes clear that the flashes of light will reach all the dust particles in the area of previously calculated spheres and ellipsoids. We get that according to the theory of relativity, different observers, after their transition to one common IFR, will fix different regions of space with dust that has been highlighted. This contradicts reality, since in fact observers will record the same picture for both of them.
