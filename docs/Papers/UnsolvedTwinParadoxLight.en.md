...
Let's consider a non-classical version of the experiment. Let the home planet move with a velocity vector $-v$ relative to the Earth. Then, after the first acceleration, the spacecraft will rest relative to the Earth and, unfortunately, at this stage, the second twin will grow old and die (in accordance with experimental data on the relativistic dynamics of short-lived particles [17-26]). We get that the first twin has aged $2t$, and the second twin has long died (already at the first long waiting time $t$) and the spacecraft has completed all the necessary steps on autopilot. That is, the clock on the spacecraft ticks $\gamma$ times faster than the clock on the home planet at the first long wait for the time $t$. It is here that we get a contradiction between the predictions of the special relativity, which claims that the clock on the spacecraft will tick $\gamma$ times slower than the clock on the home planet, and experimental data on the relativistic dynamics of short-lived particles, proving that the clock on the spacecraft will tick $\gamma$ times faster. During the second long wait for the time $t$, the clock on the spacecraft ticks $\gamma$ times slower than the clock on the home planet. In this case, it is important for us to know how much time will pass by the clock of the spacecraft and how much time will pass by the clock of the home planet, since the age of the twins depends only on this.

In order to be humane and not waste the life of one of the twins on this experiment, we can do the same with short-lived particles, the lifetime and time dilation of which are well known experimentally [16-29]. Both experiments are easy to reproduce. If the lifetime of the particles is $10t$, then according to the special theory of relativity, at the end of both versions of the experiments there should be the same result. The remaining lifetime of the first particle will be $10t-2t=8t$, and the second particle will be $10t-2t/\gamma=10t-0.002t=9.998t$ due to the time dilation effect. However, according to experimental data on the lifetime of short-lived particles [16-29], in the non-classical version of the experiment, even with the first long wait, a time equal to $t$ will pass for the first particle (the particle moves with a time dilation coefficient equal to $\gamma$ relative to the Earth), and for the second particle, a time equal to $\gamma t$ (the particle moves without time dilation relative to the Earth). Therefore, experimentally, the second particle will decay almost at the very beginning of the first long wait. The contradiction between the prediction of the special relativity and experimental data is obvious.  

To make it easier to understand what happened in these two experiments, let's consider the maximum distance that particles move away from each other. In both experiments, the distance will be equal to $vt$ in the inertial reference frame associated with the first particle. However, different distances will be obtained relative to the Earth. In the classical version of the experiment, the distance will be equal to $vt$ due to the fact that the inertial reference frame coincides with the Earth. But in the non-classical version of the experiment, the Earth, space, and other objects with relativistic velocities $v$ relative to the first particle (the observer) will be contracted $\gamma$ times (due to relativistic length contraction) and, accordingly, from the point of view of the Earth (the observer on it), the maximum distance between the particles will be decompressed and equal to $\gamma vt$. From this we get again that during the first long wait for the second particle, a time equal to $\gamma t$ will pass, since the speed at which the first particle will move away from the second particle or from the Earth will be equal to $v$. This means that experimentally, the second particle will decay almost at the very beginning of the first long wait.

Let's take another look at the clear and absolutely understandable arguments that we have relative to the Earth due to experimental data [16-29]. We are considering only the first long wait for simplicity.

In the classical version of the experiment, the second particle will travel a distance equal to $vt$ relative to an observer on Earth. At the same time, the second particle constantly experiences the effect of time dilation with a coefficient equal to $\gamma$. We get that the time $t/\gamma$ has passed for the second particle during the first long wait. As a result, the second particle will not decay until the end of the experiment. 

In a non-classical version of the experiment, the second particle will rest relative to the Earth until the first particle has traveled a distance equal to $\gamma vt$ relative to an observer on Earth. At the same time, the second particle does not experience time dilation relative to the Earth. We get that the time $\gamma t$ has passed for the second particle during the first long wait, but the special theory of relativity erroneously predicted the time equal to $t/\gamma$. As a result, the second particle will decay almost at the very beginning of the first long wait. 

It turns out that although we are conducting identical experiments from the point of view of inertial reference frames associated with the first particles, but different proper time passes for the second particles, and precisely because of this we get different experimental results. This violates the assumption of the first postulate of the special theory of relativity that any physical processes in inertial reference frames proceed in the same way and identical experimental results will be obtained.

As a result, we get that in the classical version of the experiment, the second short-lived particle will live longer. In the non-classical version of the experiment, the first particle will live to the end of the experiment, and the second particle will decay already at the first long wait and there will be nothing to accelerate at the next stage.

We get that the "traveling" twin will not always be younger than the "stay-at-home" twin.

It should be particularly noted that the classical and non-classical versions of the experiments differ only in the choice of the base inertial reference frame - the home planet or short-lived particle, and everything else is identical. That is, the difference is solely that the relative velocity between the selected home planets or short-lived particles is $v$. All other actions with spacecrafts or short-lived particles are identical: accelerations, velocities, time according to the clock of the inertial reference frame.
