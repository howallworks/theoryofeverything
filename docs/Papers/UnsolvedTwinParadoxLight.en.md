...
As a result, in the basis inertial frame of reference, we calculate the real parameters of objects, and when changing the inertial frame of reference, we calculate some illusory parameters of objects. Are the laws invariant in these inertial frames of reference? No, because in the first case we describe reality, and in the second an illusion. This proves a violation of the first postulate of the theory of relativity.
