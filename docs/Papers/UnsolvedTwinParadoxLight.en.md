...
##### Экспериментальные следствия неравноправия инерциальных систем отсчета

Из-за наличия абсолютной системы отсчета, динамика вселенной в разных инерциальных системах отсчета будет выглядеть по разному. В ИСО, двигающейся с релятивистской скоростью относительно абсолютной системы отсчета, будет наблюдаться сверхбыстрая динамика вселенной. По сути процессы в ней будут сильно замедлены, а динамика вселенной будет неизменной. Это приведет к тому, что наблюдатель в этой ИСО будет видеть все процессы вселенной ускоренными в гамма раз. То есть возраст вселенной будет увеличиваться в гамма раз быстрее чем его собственный. Необходимо особо отметить, что это не учитывает направление релятивистского движения ИСО относительно абсолютной системы отсчета. Если это не игнорировать, то необходимо учитывать время путешествия фотонов до релятивистской ИСО. Получим, что по направлению движения релятивистской ИСО мы будем наталкиваться на окружающие фотоны, а в противоположном направлении мы будем убегать от фотонов, которые будут нас очень медленно догонять.

Из-за равноправия ИСО мы даже не можем гарантировать, что человеческое тело будет корректно функционировать на релятивистских скоростях относительно абсолютной системы отсчета. Это вообще ставит под большой вопрос путешествия даже по нашей галактике. Конечно возможно будет создать систему, которая сохранит данные о нас в релятивистском путешествии по галактике, а затем после торможения до абсолютной системы отсчета (НСО) воссоздаст нас. Однако это сильно усложняет процесс и необходимые технологии.
