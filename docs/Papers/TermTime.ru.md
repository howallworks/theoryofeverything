...
Периодичность процессов во всех объектах зависит от скорости их движения относительно НСО. Например, в часах (в том числе атомных или световых). Чем выше скорость часов, тем больше времени тратиться на период электромагнитного излучения (например, атома цезия-133) или полный период световых часов.
