...
Из-за неравноправия ИСО мы даже не можем гарантировать, что человеческое тело будет корректно функционировать на релятивистских скоростях относительно абсолютной системы отсчета. Это вообще ставит под большой вопрос путешествия даже по нашей галактике. Конечно возможно будет создать систему, которая сохранит данные о нас в релятивистском путешествии по галактике, а затем, после торможения до абсолютной системы отсчета (НСО), воссоздаст нас. Однако это сильно усложняет процесс и необходимые технологии.
