...
Рассмотрим классический вариант. Пусть родная планета это Земля. Получаем, что первый близнец постарел на 2 года, а второй близнец постарел в 1000 раз меньше. Ничего интересного.

Рассмотрим неклассический вариант. Пусть родная планета движется со скоростью $-v$ относительно Земли. Тогда после ускорения космический корабль будет покоится относительно Земли и, к сожалению, на данном этапе второй близнец состарится и умрет. Получаем, что первый близнец постарел на 2 года, а второй близнец давно умер и космический корабль на автопилоте проделал все необходимые этапы.

Чтобы быть гуманными и не тратить на этот эксперимент жизнь одного из близнецов можно обойтись короткоживущими частицами. Оба эксперимента легко воспроизвести. В итоге получим, что в первом случае дольше проживет вторая короткоживущая частица. Во втором случае первая частица доживет до конца эксперимента, а вторая частица распадется при первом "длительном" ожидании времени и ускорять уже будет нечего на следующем этапе.

Как видим, инерциальные системы отсчета неравноправны и не могут быть описаны общими законами. Далее давайте разбираться в чем же кроется причина всего этого.
