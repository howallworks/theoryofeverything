...
В итоге сначала мы определяли реальные (фактические) местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности при смене ИСО получили видимые или кажущиеся или иллюзорные. Инвариантны ли законы в этих инерциальных системах отсчета? Нет, так как в первом случае мы описываем реальность, а во втором иллюзию. Следовательно, при использовании теории относительности нарушается первый постулат.
...
Как видим $l''=l/\gamma$ - это даже не видимая непосредственно длина линейки с точки зрения теории относительности, а лишь математическая иллюзия.
