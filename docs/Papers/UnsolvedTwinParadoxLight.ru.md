...
Получаем, что именно схема одновременности/синхронизации часов в каждой инерциальной системе отсчета создает математическую иллюзию длины $l''$. На практике мы должны попросить линейку отправить каждый фотон (из пары единичных источников фотонов) в разное четко определенное время, чтобы получить их синхронно в нашей ИСО и зафиксировать длину $l''$.
