...
На рисунке 4 представлено два линейных массива детекторов покоящихся в НСО.

![[fig0_04black.jpg]]

**Рисунок 4 – Два линейных массива детекторов покоящихся в НСО**

Ускорим первый до скорости $v$ за время стремящееся к нулю. Что тогда зафиксируют массивы детекторов? Каждый детектор зафиксирует наличие детекторов напротив него (рисунок 5a) и никакого сокращения длины $l''=l/\gamma$ не будет (рисунки 5b, 5c, 5d).

![[fig0_05black_2.jpg]]

**Рисунок 5 – Два линейных массива детекторов. Первый ускорили до скорости $v$ за время стремящееся к нулю**
...
Хуже того, согласно специальной теории относительности, сокращение длины первого массива детекторов должно быть мгновенным или телепортационным. То есть даже исходя из не нулевого времени ускорения первого массива детекторов, скорость сжатия должна быть сверхсветовой с итогом представленным на одном из рисунков 5b, 5c, 5d, что не соответствует экспериментальным данным и также противоречит максимальному ограничению скорости теории относительности.

Аналогичная проблема будет наблюдаться в $ИСО_v$ покоящейся относительно первого массива детекторов после ускорения. Где при непрерывном измерении должно наблюдаться сверхсветовое растяжение первого массива детекторов. 

Для скептиков, которые могут сказать: "сейчас мы не можем ускорить первый массив детекторов до релятивистских скоростей". Можно взять элементарные частицы которые легко ускорить до релятивистских скоростей. Составить из этих частиц протяженную линейку длинной $l$. И провести описанный выше эксперимент. Естественно никаких телепортаций и сверхсветовых перемещений частиц наблюдаться не будет.

В результате специальная теория относительности предсказывает, что сразу после ускорения первого массива детекторов или элементарных частиц будет измерена длина $l''=l/\gamma$, но сверхсветового сжатия не будет детектировано экспериментально, и измеренная длина останется $l$. Этого уже достаточно чтобы доказать несоответствие теории относительности экспериментальным данным.

Ещё раз простым языком. Получается, что за один тик или период часов (пусть будет одна наносекунда) измеряемая длина первого массива детекторов должна меняться с $l$ до $l''$. Фактически никто не запрещает выбрать длину массива детекторов $l$, равную нескольким миллиардам световых лет (рисунок 4). Тогда за наносекунду, для покоящегося массива детекторов с часами (второй массив детекторов), местоположение первого массива детекторов должно сместиться на миллиард световых лет (один из вариантов представленных на рисунках 5b, 5c, 5d). Конечно, это не соответствует экспериментальным данным. Также необходимо отметить, что в интерпретации теории относительности разные движущиеся детекторы должны пройти разное расстояние за наносекунду.

Предположим, вы все ещё доверяете теории относительности. Тогда доведем ситуацию до абсурда. Возьмем три массива детекторов, которые мы в дальнейшем будем одновременно ускорять за время, стремящееся к нулю. Также возьмем сверхдлинный покоящийся массив детекторов для измерения длин. Получаем картину, представленную на рисунке 6. 

![[fig0_06black.jpg]]

**Рисунок 6 – Четыре линейных массива детекторов покоящихся в НСО**

Тогда после одновременного ускорения трех массивов детекторов, согласно теории относительности, результат должен быть представлен одним из вариантов на рисунке 7.

![[fig0_07_2black.jpg]]

**Рисунок 7 – Четыре линейных массива детекторов. Первые три ускорили до скорости $v$ за время стремящееся к нулю**
**a, b, c) варианты предсказываемые специальной теорией относительности, которые не фиксируются экспериментально**

Сравнивая, например, рисунок 6 и рисунок 7c, можно заметить, что первый массив детекторов мгновенно (за время ускорения, стремящееся к нулю) преодолел пустое расстояние от C до D, которое может быть равно миллиарду световых лет. Конечно это противоречит любым экспериментальным данным и мы не сможем добиться такого результата просто ускорив объект до скорости $v$ за время, стремящееся к нулю.
Как видим, исходя из абсурдных результатов на рисунке 7, теория относительности предсказывает сверхсветовое перемещения объектов или их частей, что противоречит ограничению скорости в самой теории и экспериментальным данным. Хуже того, три массива детекторов должны вернуться в начальное состояние, представленное на рисунке 6, если мы затормозим их за время, стремящееся к нулю, до нулевой скорости относительно сверхдлинного покоящегося массива детекторов.
...
На рисунке 10 представлена картина прохождения сквозь поляризатор всех фотонов ($\int_{-\pi/4}^{\pi/4} cos(2x) \,dx$), если угол между осями поляризаторов $0^o$. 


![[fig06black.jpg]]

**Рисунок 10 – Картина прохождения сквозь поляризатор всех фотонов ($\int_{-\pi/4}^{\pi/4} cos(2x) \,dx$), если угол между осями поляризаторов $0^o$** 

На рисунке 11 представлена картина прохождения сквозь поляризатор фотонов ($\int_{-\pi/4}^{(\pi/4-\pi/8)} cos(2x) \,dx$), если угол между осями поляризаторов $\pi/8 \; (22,5^o)$. 


![[fig07black.jpg]]

**Рисунок 11 – Картина прохождения сквозь поляризатор фотонов ($\int_{-\pi/4}^{(\pi/4-\pi/8)} cos(2x) \,dx$), если угол между осями поляризаторов $\pi/8 \; (22,5^o)$** 
