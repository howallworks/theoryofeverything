...
### Преимущества и недостатки теории относительности 

Для начала рассмотрим вариант реалистичного эксперимента.

Пусть у нас есть пара спутников летающих на орбите Земли с одинаковым гравитационным воздействием по одной орбите, но в противоположных направлениях. Когда они в первый раз пролетают мимо друг друга часы синхронизируются (почти в одной точке). 

Какие часы из этой пары будут испытывать замедление времени относительно друг друга? Ответ согласно теории относительности: первые относительно вторых и вторые относительно первых. Такой ответ мы получаем из-за того что воздействие гравитации одинаково на каждые часы, но относительная скорость других часов всегда будет в наличии. Однако на практике при очередном пролёте мимо друг друга мы зафиксируем, что только одни часы замедляются по сравнению с другими.

На этом можно и закончить, но давайте все таки подробнее разберемся с тем почему теория относительности так хорошо соответствует огромному объему экспериментальных данных и в чем недостатки ее базовых предположений. 
...
Итак $l''$ это не реальная (собственная) длина и не непосредственно видимая длина. Она не отражает фактическое местоположение границ объекта (отражает только собственная длина) и не отражает непосредственно видимые наблюдателем границы. Получается что в одной ИСО в которой берём местоположения где непосредственно нет границ объекта - иллюзорные характеристики. Нельзя сказать что эти ИСО равноправны.
