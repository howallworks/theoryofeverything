...
Для этого необходимо понять принцип работы [[TheReasonForTheMisunderstandingOfTheViolationOfBellsInequality.ru|поляризатора и особенности его взаимодействия с фотонами, а также причину недопонимания нарушения неравенства Белла]]. Это объясняет все наблюдаемые экспериментальные данные и эффекты без нарушения локальности и реализма.
