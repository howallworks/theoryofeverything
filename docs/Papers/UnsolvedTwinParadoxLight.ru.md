...
Показано, что можно провести пару мысленных экспериментов, в которых всё происходящее с объектами исследования будет идентично с точки зрения теории относительности. Однако со стороны стороннего наблюдателя будут получены различные результаты, что можно подтвердить экспериментально. Кроме того, согласно теории относительности для каждого из этих мысленных экспериментов результаты рассчитанные одним из "близнецов" будут абсолютно противоположны результатам рассчитанным другим "близнецом", что невозможно в реальности. 
