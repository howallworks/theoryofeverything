...
**Рисунок 5 – Два линейных массива детекторов покоящихся в НСО. Первый ускорили до скорости $v$ за время стремящееся к нулю**
...
Для понимания рассмотрим эксперимент с двумя щелями в волновой интерпретации, представленный на рисунке 6.

![[fig04black.jpg]]

**Рисунок 6 – Интерпретация двухщелевого эксперимента согласно теории корпускулярно-волнового дуализма**
...
На рисунке 8 представлена картина прохождения сквозь поляризатор всех фотонов ($\int_{-\pi/4}^{\pi/4} cos(2x) \,dx$), если угол между осями поляризаторов $0^o$. 


![[fig06black.jpg]]

**Рисунок 8 – Картина прохождения сквозь поляризатор всех фотонов ($\int_{-\pi/4}^{\pi/4} cos(2x) \,dx$), если угол между осями поляризаторов $0^o$** 

На рисунке 9 представлена картина прохождения сквозь поляризатор фотонов ($\int_{-\pi/4}^{(\pi/4-\pi/8)} cos(2x) \,dx$), если угол между осями поляризаторов $\pi/8 \; (22,5^o)$. 


![[fig07black.jpg]]

**Рисунок 9 – Картина прохождения сквозь поляризатор фотонов ($\int_{-\pi/4}^{(\pi/4-\pi/8)} cos(2x) \,dx$), если угол между осями поляризаторов $\pi/8 \; (22,5^o)$** 
