...
Если же проанализировать, что именно нам дает применение на практике специальной теории относительности Эйнштейна, то результаты позволят нам многое переосмыслить. 
...
Какие часы из этой пары будут испытывать замедление времени? Ответ согласно теории относительности: и первые, и вторые. Такой ответ мы получаем из-за того что воздействие гравитации одинаково на каждые часы, но относительная скорость других часов всегда будет в наличии. Однако на практике при очередном пролёте мимо друг друга мы зафиксируем, что только одни часы замедляются по сравнению с другими.
