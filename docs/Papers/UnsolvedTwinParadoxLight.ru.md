...
Получаем в данном мысленном эксперименте видимая непосредственно длина линейки с точки зрения теории относительности для наблюдателя второго космического корабля находиться в интервале от A'B до AB' (A'B < AB < AB'), что не является константой $l''$. 

Как видим $l''=l/\gamma$ - это не реальная (фактическая) и даже не видимая непосредственно длина линейки с точки зрения теории относительности, а лишь математическая иллюзия.

Все это означает, что при использовании теории относительности для смены инерциальной системы отсчета мы ожидаем получить реальные (фактические) или хотя бы видимые непосредственно результаты, которые можно использовать на практике. Результаты, которые фиксирует второй наблюдатель. Однако мы получаем лишь набор чисел, которые не отражает происходящую действительность вокруг второго наблюдателя или хотя бы непосредственно видимое им. Мы получили лишь математическую иллюзию бесполезную на практике, которая хоть и сохраняет временную линию эксперимента, но не отражает происходящее вокруг второго наблюдателя.
