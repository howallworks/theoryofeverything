...
В итоге в базовой инерциальной системе отсчета мы рассчитываем реальные параметры объектов, а при смене инерциальной системы отчета рассчитываем некие иллюзорные параметры объектов. Равноправны ли законы природы в этих инерциальных системах отсчета? Нет. Это доказывает нарушение первого постулата теории относительности. 
...
В итоге в НСО мы определяли реальные местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности при смене ИСО получили кажущиеся или видимые или иллюзорные. Равноправны ли законы природы в этих инерциальных системах отсчета? Нет. Следовательно, при использовании теории относительности нарушается первый постулат.
