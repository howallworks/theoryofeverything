...
В итоге в базовой инерциальной системе отсчета мы рассчитываем реальные параметры объектов, а при смене инерциальной системы отчета рассчитываем некие иллюзорные параметры объектов. Равноправны ли они в таком случае? Нет. Это доказывает нарушение первого постулата теории относительности. 
...
Однако мы прекрасно знаем, что $l''$ это лишь кажущаяся/видимая/иллюзорная длина линейки, а не реальная. Это также означает, что $v''$ тоже некая кажущаяся/видимая/иллюзорная скорость, а не реальная. Получаем, что если нам требуется рассчитать реальные характеристики объектов, а не иллюзорные, то теорию относительности нельзя применять.  

В итоге в НСО мы определяли реальные местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности при смене ИСО получили кажущиеся/видимые/иллюзорные. Равноправны ли такие инерциальные системы отсчета? Нет. Следовательно при использовании теории относительности нарушается первый постулат.
