...
Хуже того, согласно специальной теории относительности, сокращение длины массива детекторов должно быть мгновенным или телепортационным. То есть даже исходя из не нулевого времени ускорения массива детекторов, скорость сжатия должна быть сверхсветовой с итогом представленным на одном из рисунков 5b, 5c, 5d, что не соответствует экспериментальным данным и также противоречит максимальному ограничению скорости теории относительности.
...
Для скептиков, которые могут сказать: "сейчас мы не можем ускорить массив детекторов до релятивистских скоростей". Можно взять элементарные частицы которые легко ускорить до релятивистских скоростей. Составить из этих частиц протяженную линейку длинной $l$. И провести описанный выше эксперимент. Естественно никаких телепортаций и сверхсветовых перемещений частиц наблюдаться не будет.
...
Ещё раз простым языком. Получается, что за один тик или период часов (пусть будет одна наносекунда) измеряемый размер линейки должен меняться с $l$ до $l''$. Фактически никто не мешает выбрать длину массива детекторов $l$, равную нескольким миллиардам световых лет (рисунок 4). Тогда за наносекунду для покоящегося массива детекторов с часами местоположение движущегося со скоростью $v$ массива детекторов должно сместиться на миллиард световых лет (один из вариантов представленных на рисунках 5b, 5c, 5d). Конечно, это не соответствует экспериментальным данным. Также необходимо отметить, что в интерпретации теории относительности разные движущиеся детекторы должны пройти разное расстояние за наносекунду.
