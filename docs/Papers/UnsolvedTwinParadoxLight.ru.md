...
Рассмотрим неклассический вариант эксперимента. Пусть родная планета движется со скоростью $-v$ относительно Земли. Тогда после ускорения космический корабль будет покоится относительно Земли и, к сожалению, на данном этапе второй близнец состарится и умрёт. Получаем, что первый близнец постарел на 2 года, а второй близнец давно умер и космический корабль на автопилоте проделал все необходимые этапы. То есть часы на космическом корабле шли в 1000 раз быстрее, чем часы на родной планете при первом "длительном" ожидании времени $t$.

Чтобы быть гуманными и не тратить на этот эксперимент жизнь одного из близнецов, можно обойтись короткоживущими частицами. Оба эксперимента легко воспроизвести. В итоге получим, что в первом случае дольше проживет вторая короткоживущая частица. Во втором случае первая частица доживет до конца эксперимента, а вторая частица распадется при первом "длительном" ожидании и ускорять уже будет нечего на следующем этапе.

Получаем, что "путешествующий" близнец не всегда будет моложе близнеца "домоседа".
Как видим, инерциальные системы отсчета (для разных вариантов покоящихся родных планет) неравноправны и не могут быть описаны общими законами. Далее давайте разбираться, в чем же кроется причина всего этого.
