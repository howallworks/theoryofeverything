...
Хуже того, согласно специальной теории относительности, сокращение длины массива детекторов должно быть мгновенным/телепортационным. То есть даже исходя из не нулевого времени ускорения массива детекторов, скорость "сжатия" должна быть сверхсветовой с итогом представленным на одном из рисунков 5b, 5c, 5d, что не соответствует экспериментальным данным и также противоречит максимальному ограничению скорости теории относительности.
...
Этого уже достаточно чтобы доказать несоответствие теории относительности экспериментальным данным.
