...
В итоге в НСО мы определяли реальные местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности получили кажущиеся/видимые/иллюзорные. Равноправны ли такие инерциальные системы отсчета? Нет. Следовательно при использовании теории относительности нарушается первый постулат.

Специальная теория относительности в каждом конкретном эксперименте математически верно описывает поведение каждого объекта. Причина в том, что для этого объекта последовательность событий и собственная временная линия не меняются при смене ИСО, а поведение окружающих объектов подстраивается соответственно. Однако это математическое описания лишь иллюзия, которая не дает нам понять, что же в действительности происходит с исследуемыми объектами.
