...
3. Первую ускорим до скорости близкой к скорости света, а вторую до 0. 
4. Подождем значительное время $t$. 
5. Ускорим обе обратно до $0.5c$. 
6. Ускорим их обе до 0. 
7. Ускорим их обе до $-0.5c$. 
8. Первую ускорим до скорости близкой к $-c$, а вторую до 0. 
9. Подождем значительное время $t$. 
10. Ускорим их обе до $-0.5c$. 
11. Ускорим их обе до 0. 
...
2. Первую ускорим до 0, а вторую до $c$. 
3. Подождем значительное время $t$. 
4. Ускорим обе обратно до $0.5c$. 
5. Первую ускорим до $0.6c$, а вторую до $0.4c$. 
...
1. Начало. Они летят вместе. Пусть $v=-0.5c$. 
2. Первую ускорим до $-c$, а вторую до 0. 
3. Подождем значительное время $t$. 
4. Ускорим обе обратно до $-0.5c$. 
5. Первую ускорим до $-0.4c$, а вторую до $-0.6c$. 
6. Подождем значительное время $5t$. 
7. Ускорим их обе до $-0.5c$. 
8. Они летят вместе. Конец мысленного эксперимента. 
...
Мысленный эксперимент 4. Они летят вместе. Пусть $v=0$. Первая всегда покоится. Вторую ускорим до $c$. Подождем значительное время $0.5t$. Ускорим вторую до $-c$. Подождем значительное время $0.5t$. Ускорим вторую до $0$. Они летят вместе. Конец мысленного эксперимента. 
...
Результаты первого объекта будут идентичны результатам НСО, так как система отсчета совпадает.

Для второго объекта изменение собственного времени зафиксированное на часах будет практически нулевым. Однако в структуре вселенной будут зафиксированы колоссальные изменения. Объекты, скорость которых стремится к скорости света в НСО пройдут расстояние практически в миллиард световых лет. Это значит что их скорость относительно второго объекта стремится к бесконечности (миллиард световых лет делим на время стремящееся к нулю). Однако это невозможно согласно теории относительности, так как предельная скорость равна скорости света. 

Получаем противоречие: 

- либо скорость объектов может стремиться к бесконечности с нулевым изменением времени на часах второго объекта.
- либо на часах второго объекта должно пройти столько же времени сколько и для первого объекта (миллиард лет). 

Получаем что вселенная изменилась на миллиард лет, но время для второго объекта практически не изменилось.
