...
В классическом варианте эксперимента вторая частица преодолеет расстояние равное $vt$ относительно наблюдателя на Земле. При этом вторая частица все время испытывает эффект замедления времени с коэффициентом равным $\gamma$. Получаем, что за первое длительное ожидание для второй частицы прошло время $t/\gamma$. Как результат, вторая частица не распадется до конца эксперимента. 

В неклассическом варианте эксперимента вторая частица будет покоится, пока первая частица преодолеет расстояние равное $\gamma vt$ относительно наблюдателя на Земле. При этом вторая частица не испытывает замедления времени относительно Земли. Получаем, что за первое длительное ожидание для второй частицы прошло время $\gamma t$, но специальная теория относительности ошибочно предсказывала время равное $t/\gamma$. Как результат, вторая частица распадется почти в самом начале первого длительного ожидания. 
...
Необходимо особо отметить, что классический и неклассический варианты экспериментов отличаются лишь выбором базовой инерциальной системы отсчета - родной планетой или короткоживущей частицей, а всё прочее идентично. То есть разница исключительно в том, что относительная скорость между выбранными родными планетами или короткоживущими частицами - $v$. Все прочие действия с космическими кораблями или короткоживущими частицами идентичны: ускорения, скорости, время по часам инерциальной системы отсчета. 
