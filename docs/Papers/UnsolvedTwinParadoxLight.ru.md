...
Однако мы прекрасно знаем, что $l''=l/\gamma$ это лишь видимая непосредственно или кажущаяся или иллюзорная длина линейки, а не реальная (фактическая). Это также означает, что $v''$ тоже некая видимая непосредственно или кажущаяся или иллюзорная скорость, а не реальная (фактическая). В результате при использовании здесь теории относительности мы получили именно видимые непосредственно или кажущиеся или иллюзорные характеристики объектов, а не реальные (фактические). Здесь как раз учитывается время на полет фотонов от источника до наблюдателя, а значит за время полета этих фотонов местоположения и прочие реальные (фактические) характеристики объектов - изменятся.
...
В итоге сначала мы определяли реальные (фактические) местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности при смене ИСО получили видимые непосредственно или кажущиеся или иллюзорные. Инвариантны ли законы в этих инерциальных системах отсчета? Нет, так как в первом случае мы описываем реальность, а во втором иллюзию. Следовательно, при использовании теории относительности нарушается первый постулат.
