...
В итоге в НСО мы определяли реальные местоположения, скорости, время и прочие характеристики объектов, а после применения специальной теории относительности при смене ИСО получили кажущиеся или видимые или иллюзорные. Равноправны ли такие инерциальные системы отсчета? Нет. Следовательно, при использовании теории относительности нарушается первый постулат.
