...
Синхронизация в одной ИСО это рассинхронизация в другой ИСО. Ускорив объект за время стремящееся к нулю часы в любой части объекта всё ещё синхронны с базовой ИСО и в последствии лишь замедляют ход часов, а точнее увеличивают длительность их периода в атомах цезия-133 или любых других периодических процессов по сравнению с часами исходной ИСО/НСО. Если мы не будем проводить "синхронизацию" часов сразу после ускорения, а получим излученную пару единичных фотонов от объекта из мысленного эксперимента 2 (фотоны излучены одновременно в ИСО объекта), то зафиксируем длину $l$ одновременно по часам детекторов. Это означает что именно метод "синхронизации" часов создает иллюзию длины объекта $l''$. 
