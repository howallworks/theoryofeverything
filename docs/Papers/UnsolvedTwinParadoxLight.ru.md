...
Фактически сокращение Лоренца фиксируется только в ИСО, которые движутся относительно НСО. Причем это вызвано сугубо рассинхронизацией часов и движением измеряемого объекта относительно этой ИСО. Более того, при этом объект исследования, на который не действует ускорение, остается в одном и том же состоянии во всех ИСО, а используемые методы измерения и рассинхронизации часов создают лишь иллюзию, не описывающую собственное состояние объекта.
