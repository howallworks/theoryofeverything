...
Фактически здесь вопрос о том "может ли квант фотон изменять [[Helicity.en|helicity]] при взаимодействии с [[Quantum graviton.en|quantum gravitons]]?". 

Если нет. Тогда позитрон может излучать группу $q.ph.^-$( $photon^-$), которая ранее была поглощена и входила в его составе. В этом случае в его состав могут входить как $q.ph.^+$ так и $q.ph.^-$ связанные вместе благодаря $q.g.$. Тогда если постоянно пускать в позитрон $photon^-$ (группы $q.ph.^-$), то $q.ph.^-$ станет больше чем $q.ph.^+$ и позитрон "превратится" в электрон? При такой ситуации позитроны не будут взаимозаменяемы, так как в них будет разное количество $q.ph.^+$ и $q.ph.^-$ и, соответственно, их поведение будет различно. Получается состояние между позитроном и электроном будет размыто и зависить от соотношения $q.ph.^+$ и $q.ph.^-$. Рассмотрим для этого случая атом водорода. Электрон будет постоянно получать $q.ph.^+$ от протона, а протон $q.ph.^-$ от электрона. Тогда величина избыточного излучения $q.ph.^-$ от электрона и $q.ph.^+$ от протона будет уменьшаться во времени и вскоре обе частицы станут электронейтральными (как минимум одна частица станет электронейтральной) и атом разлетится на электронейтральные части. 
Вселенная в среднем электронейтральна, а следовательно все заряженые частицы будут обмениваться в среднем одинаковым потоком $q.ph.^+$ и $q.ph.^-$. При этом положительно заряженые частицы вначале будут излучать в основном $q.ph.^+$, а отрицательно заряженые частицы вначале будут излучать в основном $q.ph.^-$. Далее все заряженые частицы будут быстро терять индивидуальность заряда и станут электронейтральными.
Всё это не соответствует наблюдаемой динамике электрона, позитрона и прочих заряженых частиц.

В итоге получаем, что квант фотон может изменять [[Helicity.en|helicity]] при взаимодействии с [[Quantum graviton.en|quantum gravitons]].
Позитроны излучают/содержат исключительно [[Photon.en|photons]] состоящие из $q.ph.^+$. 
Электроны излучают/содержат исключительно [[Photon.en|photons]] состоящие из $q.ph.^-$. 
При поглощении/присоединении $q.ph.$ с противоположной [[Helicity.en|helicity]] к позитрону/электрону - она инвертируется и также инвертируется вектор скорости (более сложные заряженые частицы фактически состоят из позитрона/электрона и нейтрального остатка. Например, протон состоит из позитрона и нейтрального остатка).
