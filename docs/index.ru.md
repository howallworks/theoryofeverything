...
-   гравитоны могут не излучаться во все стороны трехмерного пространства равномерно, так, например, функционируют [[SMBH.ru|СМЧД]] с [[Релятивисткая струя.ru|релятивистскими струями]] - [[Блазар.ru|блазары]];
