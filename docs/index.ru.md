...
Рассмотрим атом водорода (учитывая возможность преобразований $p^+ → n + e^+ + ν_e$ и $n → p^+ + e^- + \overline ν_e$):
$p^+ + e^- →$$n + e^+ + ν_e + e^- →$
