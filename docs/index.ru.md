...
Тогда как функционирует [[SMBH.ru|СМЧД]] с [[Релятивисткая струя.ru|релятивистскими струями]]([[Blazar.ru|Блазар]])? 
...
-   гравитоны могут не излучаться во все стороны трехмерного пространства равномерно, так, например, функционируют [[SMBH.ru|СМЧД]] с [[Релятивисткая струя.ru|релятивистскими струями]] - [[Blazar.ru|блазары]];
