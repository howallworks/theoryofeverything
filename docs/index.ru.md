...
Как видно протон не является элементарной частицей (состоит из $к.ф.^+$, $к.ф.^-$ и к.г.) и нестабилен (дополнительные разъяснения в разделе «[[index.ru#Стабильность систем элементарных частиц|Стабильность систем элементарных частиц]]»). 
...
Все объекты Вселенной (обладающие массой) генерируют гравитационное излучение, тратят на это энергию и оказывают силовое воздействие на окружающие объекты (детали в разделе «[[index.ru#Неравномерность гравитации. Квант гравитон. Блазар - СМЧД с релятивистскими струями|Неравномерность гравитации. Квант гравитон. Блазар - СМЧД с релятивистскими струями]]»)
...
### Ключевые особенности теории всего

В каждой теории есть ряд ключевых особенностей, которые формируют её базу и отличают от других теорий.

Опишем ключевые особенности теории всего:

- период излучения атома цезия-133 зависит от скорости движения относительно НСО или ИСО. Вообще любые процессы для систем элементарных частиц зависят от скорости движения относительно НСО (от времения жизни частиц до атомов и макро объектов). Здесь особенность заключается в определении термина "Время" отличного от того, которое стало основой [[GTR.ru|ОТО]] 
- квант гравитон - элементарная частица, а не диформация пространства-времени массой. Здесь особенность в понимании источника гравитации
- частицы СМ не превращаются, а происходит перераспределение элементарных частиц из которых они состоят. Особенность в понимании того, что элементарные частицы стабильны и не могут превращаться/преобразовываться/излучать/поглощать
- динамика элементарных частиц предопределена (судьба). Особенность в понимании того, что вероятности - последвтвия погрешностей в условиях экспериментов. А если в Мире действуют законы, то их последствия однозначны
- воздействие на элементарные частицы или системы изменяет их динамику. Сайчас начали частично понимать эту особенность, как причину "эффекта наблюдателя" и прочих
- всё элементарные частицы - корпоскулы. Нет волновых свойств у элементарных частиц. Особенность в понимании прераспределения/переизлучения элементарных частиц в пространстве, а не в наложении волн. Например, невозможно нейтализовать один фотонный пучек другим (находятся в противофазе друг к другу), что реально с точки зрения теории волн