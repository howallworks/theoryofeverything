...
Что мы имеем. Две черные дыры сливаясь излучили ограмное количество [[Quantum graviton.ru|гравитонов]] за короткий промежуток времени, что мы зафиксировали благодаря [[LIGO.ru|LIGO]]. Также мы поняли, что скорость разпространения гравитонов равна скорости света.
...
Рассмотрим атом водорода (учитывая $p^+ → n + e^+ + ν_e$ и $n → p^+ + e^- + \overline ν_e$):
$p^+ + e^- →$$n + e^+ + ν_e + e^- →$
$p^+ + e^- + \overline ν_e + ν_e + \gamma_1 →$$n + e^+ + ν_e + e^- + \gamma_2 →$
$p^+ + e^- + \overline ν_e + ν_e + \gamma_3 →$$n + e^+ + ν_e + e^- + \gamma_4 →$
$p^+ + e^- + \overline ν_e + ν_e + \gamma_5 →$$n + e^+ + ν_e + e^- + \gamma_6 →$
$... → \text{и так далее}$
При этом количество получаемых фотонов растет пока в протоне или нейтроне хватает $к.ф.^+$, $к.ф.^-$ и к.г..

Как видно протон не является элементарной частицей (сосотит из $к.ф.^+$, $к.ф.^-$ и к.г.) и нестабилен (допольнительные разъяснения в разделе «[[index.ru#^Стабильность систем элементарных частиц|Стабильность систем элементарных частиц]]»). 
